# 북한 전략시설 위성 정기 모니터링 — 강선 농축시설 (건설·시설 확대)

**상태**: 🟢 평년(특이 변화 없음) · **발행**: 2026-06-18 09시 · **분야**: 건설·시설 확대 · **센서**: Sentinel-2 L2A (ESA) · 10 m · **공개 OSINT**
