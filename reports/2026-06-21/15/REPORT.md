...
**상태**: 🟢 평년(특이 변화 없음) · **발행**: 2026-06-21 15시 · **분야**: 토목·굴착 · **센서**: Sentinel-2 L2A (ESA) · 10 m · **공개 OSINT**
**대상 추정**: 신포 남 조선소(SLBM)(Sinpo) · SLBM·잠수함 관련 조선소 추정
**원본 촬영**: 2026.06.10 11:26 KST (구름 23.6%, 신규 위성영상) · **분석창**: 중심 ±2.6km
...
## 1단계 — 발견 (최신 1장)
- 2026.06.10 11:26 KST 촬영 영상이 신포 남 조선소(SLBM) 부지에 걸쳐, 분석창 안에서 토목·굴착(신규 나지(굴착·정지) 면적(%))을(를) 분석했습니다.
- 신규 나지(굴착·정지) 면적(%): 약 10.63.
- 나지(토목·굴착토 추정) 면적 약 10.63%
- 갱도 굴착토·정지작업·신규 부지 여부 점검

## 2단계 — 시계열 검증 (같은 계절·연도별)
같은 시설의 과거 같은 계절 청천 영상(7개)과 비교해 검증합니다.
- 과거: 05-23 24.2, 06-16 18.25, 07-06 8.15, 05-22 21.3, 06-16 10.51, 06-10 12.69, 06-30 10.05
- 현재: 06-10 약 10.63
- **판정: 과거 평균(약 15.02) 대비 평년 수준**
...
---
_AssiWorks - KINAC · 2026-06-21 15시 · 공개 OSINT · Sentinel-2 (ESA)_
