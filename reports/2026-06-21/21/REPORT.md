# 북한 전략시설 위성 정기 모니터링 — 동해(무수단리) 발사장 (지표 교란(종합 활동))

**상태**: 🟢 평년(특이 변화 없음) · **발행**: 2026-06-21 21시 · **분야**: 지표 교란(종합 활동) · **센서**: Sentinel-2 L2A (ESA) · 10 m · **공개 OSINT**
**대상 추정**: 동해(무수단리) 발사장(Tonghae) · 구 대포동 발사장 추정
**원본 촬영**: 2026.05.31 11:26 KST (구름 2.4%, 신규 위성영상) · **분석창**: 중심 ±3.0km
...
## 1단계 — 발견 (최신 1장)
- 2026.05.31 11:26 KST 촬영 영상이 동해(무수단리) 발사장 부지에 걸쳐, 분석창 안에서 지표 교란(종합 활동)(인공 교란면 비율(%))을(를) 분석했습니다.
- 인공 교란면 비율(%): 약 6.59.
- 인공 교란면(나지+포장) 약 6.59%
- 부지 전반의 활동·개발 강도 추정
...
- 과거: 08-03 0.56, 06-03 7.13, 06-08 4.77, 06-08 5.59, 06-16 5.93, 06-27 2.0, 06-22 2.66
- 현재: 05-31 약 6.59
- **판정: 지표 교란이 과거 대비 큰 편(과거 평균 약 4.09)**
...
---
_AssiWorks - KINAC · 2026-06-21 21시 · 공개 OSINT · Sentinel-2 (ESA)_
