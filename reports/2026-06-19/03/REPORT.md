...
**상태**: 🟢 평년(특이 변화 없음) · **발행**: 2026-06-19 03시 · **분야**: 토목·굴착 · **센서**: Sentinel-2 L2A (ESA) · 10 m · **공개 OSINT**
**대상 추정**: 평산 우라늄 제련(Pyongsan) · 우라늄 광산·제련(옐로케이크) 추정
**원본 촬영**: 2026.06.15 11:27 KST (구름 2.4%, 신규 위성영상) · **분석창**: 중심 ±2.6km
...
- 신규 나지(굴착·정지) 면적(%): 약 8.67.
- 나지(토목·굴착토 추정) 면적 약 8.67%
...
---
_AssiWorks - KINAC · 2026-06-19 03시 · 공개 OSINT · Sentinel-2 (ESA)_
