...
**상태**: 🟠 변화 감지 · **발행**: 2026-06-19 21시 · **분야**: 수계·냉각수 변화 · **센서**: Sentinel-2 L2A (ESA) · 10 m · **공개 OSINT**
**대상 추정**: 평산 우라늄 제련(Pyongsan) · 우라늄 광산·제련(옐로케이크) 추정
**원본 촬영**: 2026.05.29 11:36 KST (구름 0.2%, 신규 위성영상) · **분석창**: 중심 ±2.6km
...
## 핵심 발견
> **수계·냉각수 변화 신호 — 수면적 과거 같은 계절 대비 축소(현 약 1.83%)**

## 1단계 — 발견 (최신 1장)
- 2026.05.29 11:36 KST 촬영 영상이 평산 우라늄 제련 부지에 걸쳐, 분석창 안에서 수계·냉각수 변화(수면적 비율(%))을(를) 분석했습니다.
- 수면적 비율(%): 약 1.83.
- 분석창 내 수면적 약 1.83%
...
---
_AssiWorks - KINAC · 2026-06-19 21시 · 공개 OSINT · Sentinel-2 (ESA)_
